...
const Bouquets = () => {
  ...
  const filtered = useMemo(() => {
    return items
      ...
      .filter((i) => (showPrices ? i.price <= maxPrice : true))
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <motion.h1 layoutId="bouquets-title" className="font-playfair text-4xl font-bold">
          Bouquets
        </motion.h1>
